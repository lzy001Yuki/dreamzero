...
Usage:
  python scripts/data/inject_task.py \
      --dataset-path /path/to/find9shape_dataset

  # Copy to a new dataset directory first:
  python scripts/data/inject_task.py \
      --dataset-path /inspire/hdd/project/robot-reasoning/xuyue-p-xuyue/zhiyan/data/baseline_mem_v2/find_imposter_shape_9_vla_v0_text \
      --output-path /inspire/hdd/project/robot-reasoning/xuyue-p-xuyue/zhiyan/data/baseline_mem_v2/find_imposter_shape_9_vla_v0_textdreamzero
"""
